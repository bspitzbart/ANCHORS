...
print "collect_target_table.pl $ARGV[0] $ARGV[1] $ARGV[2]\n";
...
if ($proc eq "-f") {
  ...
  `$prog_dir/run_dmextract.pl $ARGV[0] $ARGV[1] $ARGV[2]`;

  print "run_dmcopy.pl $ARGV[0] $ARGV[1] $ARGV[2]\n";
  `$prog_dir/run_dmcopy.pl $ARGV[0] $ARGV[1]`;

  print "run_bblocks.pl $ARGV[0] $ARGV[1]\n";
  `$prog_dir/run_bblocks.pl $ARGV[0] $ARGV[1]`;

  print "run_gl.pl $ARGV[0] $ARGV[1]\n";
  `$prog_dir/run_gl.pl $ARGV[0] $ARGV[1]`;

  print "run_quantile.pl $ARGV[0] $ARGV[1]\n";
  `$prog_dir/run_quantile.pl $ARGV[0] $ARGV[1]`;
  ...
  `$prog_dir/collect_skyview.pl $ARGV[0] $ARGV[1]`;

  print "collect_img_to_jpg.pl $ARGV[0] $ARGV[1]\n";
  `$prog_dir/collect_img_to_jpg.pl $ARGV[0] $ARGV[1]`;

  # do 2MASS matching
  print "run_2mass.pl $ARGV[0] $ARGV[1]\n";
  `$prog_dir/run_2mass.pl $ARGV[0] $ARGV[1]`;
}  # if ($proc eq "-f") {
