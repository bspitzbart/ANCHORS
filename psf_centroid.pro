...
aperture= '/data/ANCHORS/YAXX/'+obsidf+'/Data/obs'+obsid+'/ApertureImages/aperture'
...
quote='"'
;spawn, '/home/ascds/DS.release/bin/dmcopy ' + quote + eventfile + '[sky=' + regionsarray + '][bin x=' +$
spawn, '/soft/ciao3.4/bin/dmcopy ' + quote + eventfile + '[sky=' + regionsarray + '][bin x=' +$
