...
obsid  = '7254'
obsidf = '07254'
nominalRA  = 3.0181075271706E+02 ; from evt2 FITS file
nominalDec = 2.7477368442062E+01
...
readcol, '/data/mta4/AExtract/YAXX/'+obsidf+'/sample.rdb', $
; readcol, '/data/mta4/AExtract/YAXX/LkHa101/src_psf_Cell_RA_Dec.reg', $
...
;readcol, '/data/mta4/AExtract/YAXX/LkHa101/mk_psf_ell_Creg.log', $
readcol, '/data/mta4/AExtract/YAXX/'+obsidf+'/LOG/mk_psf_ell_Creg.log', $
...
;********  PLOT ********
;set_plot, 'ps'
;device, filename='/data/mta4/AExtract/YAXX/'+obsidf+'/offset_vs_offaxis.ps'
;
;------------2MASS Match plot:------------------
;
...
;loadct, 2     ;!!!!! select
set_plot, 'ps'
;device, filename='/data/mta4/AExtract/YAXX/LkHa101/2MASS_cctracks_labels.ps'
device, filename='/data/mta4/AExtract/YAXX/'+obsidf+'/2MASS_cctracks_nolabels.ps'
;device, /color   ; !!!! select
...
device, /color
device, /landscape
device, filename='/data/mta4/AExtract/YAXX/'+obsidf+'/2MASS_errors.ps'
; device, filename='/data/mta4/AExtract/YAXX/LkHa101/2MASS_errors.ps'
...
set_plot, 'ps'
device, filename='/data/mta4/AExtract/YAXX/'+obsidf+'/JvsJmK_10_label.ps'
;device, filename='/data/mta4/AExtract/YAXX/LkHa101/JvsJmK_10_label.ps'
device, /color
;!p.multi=[0,2,1]
errcut = where((e_kmag[pTM_cutoff] le 0.1 ) and (e_hmag[pTM_cutoff] lt 900) and (e_jmag[pTM_cutoff] lt 900))
...
;     ----------------------
  ...
  openw, 3, '/data/mta4/AExtract/YAXX/'+obsidf+'/Data/obs'+obsid+'/src' + strcompress((i+1),/remove_all) + '/tmc.match'
;  openw, 3, '/data/mta4/AExtract/YAXX/LkHa101/Data/obs54289/src' + strcompress((i+1),/remove_all) + '/tmc.match'
  ...
  printf, 3, offax[i], ang[i], raX[i], decX[i], raj2000tm, dej2000tm, mdiffTMs, JmagTm,e_JmagTm, HmagTm,e_HmagTm, KmagTm,e_KmagTm, $
